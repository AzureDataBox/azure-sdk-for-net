...
namespace Azure.Management.DataBox.Models
{
    ...
    public partial class DataTransferDetailsValidationResponseProperties : ValidationInputResponse
    {
        ...
        internal DataTransferDetailsValidationResponseProperties(ValidationInputDiscriminator validationType, CloudError error, ValidationStatus? status) : base(validationType, error)
        {
            Status = status;
