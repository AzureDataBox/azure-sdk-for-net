...
namespace Azure.Management.DataBox.Models
{
    ...
    public partial class ShipmentPickUpResponse
    {
        ...
        /// <param name="readyByTime"> Time by which shipment should be ready for pick up, this is in local time of pick up area. </param>
        internal ShipmentPickUpResponse(string confirmationNumber, DateTimeOffset? readyByTime)
        {
        ...
        public DateTimeOffset? ReadyByTime { get; }
    }
}
