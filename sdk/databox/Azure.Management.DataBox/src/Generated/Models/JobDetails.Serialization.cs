...
namespace Azure.Management.DataBox.Models
{
    public partial class JobDetails : IUtf8JsonSerializable
    {
        ...
        internal static JobDetails DeserializeJobDetails(JsonElement element)
        {
            ...
            return new JobDetails(jobStages, contactDetails, shippingAddress, deliveryPackage, returnPackage, dataImportDetails, dataExportDetails, jobDetailsType, preferences, copyLogDetails, reverseShipmentLabelSasKey, chainOfCustodySasKey, keyEncryptionKey, expectedDataSizeInTerabytes);
        }
    }
}
