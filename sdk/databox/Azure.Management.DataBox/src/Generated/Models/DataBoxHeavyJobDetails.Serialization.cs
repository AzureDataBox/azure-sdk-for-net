...
namespace Azure.Management.DataBox.Models
{
    public partial class DataBoxHeavyJobDetails : IUtf8JsonSerializable
    {
        ...
        internal static DataBoxHeavyJobDetails DeserializeDataBoxHeavyJobDetails(JsonElement element)
        {
            ...
            return new DataBoxHeavyJobDetails(jobStages, contactDetails, shippingAddress, deliveryPackage, returnPackage, dataImportDetails, dataExportDetails, jobDetailsType, preferences, copyLogDetails, reverseShipmentLabelSasKey, chainOfCustodySasKey, keyEncryptionKey, expectedDataSizeInTerabytes, copyProgress, devicePassword);
        }
    }
}
