...
namespace Azure.Management.DataBox.Models
{
    public partial class DataBoxDiskJobDetails : IUtf8JsonSerializable
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer)
        {
            ...
            {
                writer.WritePropertyName("disksAndSizeDetails");
                writer.WriteStartObject();
        ...
        internal static DataBoxDiskJobDetails DeserializeDataBoxDiskJobDetails(JsonElement element)
        {
            ...
            IList<DataBoxDiskCopyProgress> copyProgress = default;
            ...
            return new DataBoxDiskJobDetails(jobStages, contactDetails, shippingAddress, deliveryPackage, returnPackage, dataImportDetails, dataExportDetails, jobDetailsType, preferences, copyLogDetails, reverseShipmentLabelSasKey, chainOfCustodySasKey, keyEncryptionKey, expectedDataSizeInTerabytes, preferredDisks, copyProgress, disksAndSizeDetails, passkey);
        }
    }
}
