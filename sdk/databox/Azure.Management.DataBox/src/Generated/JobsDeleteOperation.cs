...
namespace Azure.Management.DataBox
{
    ...
    public partial class JobsDeleteOperation : Operation<Response>, IOperationSource<Response>
    {
        ...
        {
            _operation = new ArmOperationHelpers<Response>(this, clientDiagnostics, pipeline, request, response, OperationFinalStateVia.Location, "JobsDeleteOperation");
        }
        /// <inheritdoc />
