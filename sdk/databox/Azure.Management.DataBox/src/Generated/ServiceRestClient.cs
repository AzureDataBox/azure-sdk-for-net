...
namespace Azure.Management.DataBox
{
    internal partial class ServiceRestClient
    {
        ...
        public ServiceRestClient(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, string subscriptionId, Uri endpoint = null, string apiVersion = "2020-04-01")
        {
        ...
        public async ValueTask<Response<RegionConfigurationResponse>> RegionConfigurationAsync(string location, RegionConfigurationRequest regionConfigurationRequest, CancellationToken cancellationToken = default)
        {
            if (location == null)
            {
        ...
        internal HttpMessage CreateGetHealthRequest(string location)
        {
            var message = _pipeline.CreateMessage();
            var request = message.Request;
            ...
            uri.AppendPath("/providers/Microsoft.DataBox/locations/", false);
            uri.AppendPath(location, true);
            uri.AppendPath("/serviceHealth", false);
            uri.AppendQuery("api-version", apiVersion, true);
            request.Uri = uri;
            return message;
        }
        ...
        /// <param name="location"> The location of the resource. </param>
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        public async ValueTask<Response<ServiceHealthResponseList>> GetHealthAsync(string location, CancellationToken cancellationToken = default)
        {
            if (location == null)
            {
                throw new ArgumentNullException(nameof(location));
            ...
            using var message = CreateGetHealthRequest(location);
            await _pipeline.SendAsync(message, cancellationToken).ConfigureAwait(false);
            switch (message.Response.Status)
            {
                case 200:
                    {
                        ServiceHealthResponseList value = default;
                        using var document = await JsonDocument.ParseAsync(message.Response.ContentStream, default, cancellationToken).ConfigureAwait(false);
                        if (document.RootElement.ValueKind == JsonValueKind.Null)
                        {
                            value = null;
                        ...
                        {
                            value = ServiceHealthResponseList.DeserializeServiceHealthResponseList(document.RootElement);
                        }
                        return Response.FromValue(value, message.Response);
                    }
                default:
        ...
        /// <param name="location"> The location of the resource. </param>
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        public Response<ServiceHealthResponseList> GetHealth(string location, CancellationToken cancellationToken = default)
        {
            if (location == null)
            {
                throw new ArgumentNullException(nameof(location));
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        public async ValueTask<Response<AddressValidationOutput>> ValidateAddressAsync(string location, ValidateAddress validateAddress, CancellationToken cancellationToken = default)
        {
            if (location == null)
            {
                throw new ArgumentNullException(nameof(location));
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        public async ValueTask<Response<ValidationResponse>> ValidateInputsAsync(string location, ValidationRequest validationRequest, CancellationToken cancellationToken = default)
        {
            if (location == null)
            {
                throw new ArgumentNullException(nameof(location));
        ...
        internal HttpMessage CreateUnRegisterProviderRequest()
        {
            var message = _pipeline.CreateMessage();
            var request = message.Request;
            request.Method = RequestMethod.Post;
            ...
            uri.AppendPath("/subscriptions/", false);
            uri.AppendPath(subscriptionId, true);
            uri.AppendPath("/providers/Microsoft.DataBox/unregister", false);
            uri.AppendQuery("api-version", apiVersion, true);
            request.Uri = uri;
            return message;
        }
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        public async ValueTask<Response<object>> UnRegisterProviderAsync(CancellationToken cancellationToken = default)
        {
            using var message = CreateUnRegisterProviderRequest();
            await _pipeline.SendAsync(message, cancellationToken).ConfigureAwait(false);
            switch (message.Response.Status)
            {
                case 200:
        ...
        /// <summary> Un-registers Provider. </summary>
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        public Response<object> UnRegisterProvider(CancellationToken cancellationToken = default)
        {
            using var message = CreateUnRegisterProviderRequest();
            _pipeline.Send(message, cancellationToken);
            switch (message.Response.Status)
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        public async ValueTask<Response<AvailableSkusResult>> ListAvailableSkusByResourceGroupAsync(string resourceGroupName, string location, AvailableSkuRequest availableSkuRequest, CancellationToken cancellationToken = default)
        {
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        public async ValueTask<Response<RegionConfigurationResponse>> RegionConfigurationByResourceGroupAsync(string resourceGroupName, string location, RegionConfigurationRequest regionConfigurationRequest, CancellationToken cancellationToken = default)
        {
            if (resourceGroupName == null)
            {
                throw new ArgumentNullException(nameof(resourceGroupName));
        ...
        /// <param name="validationRequest"> Inputs of the customer. </param>
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        public async ValueTask<Response<ValidationResponse>> ValidateInputsByResourceGroupAsync(string resourceGroupName, string location, ValidationRequest validationRequest, CancellationToken cancellationToken = default)
        {
            if (resourceGroupName == null)
            {
                throw new ArgumentNullException(nameof(resourceGroupName));
        ...
        /// <param name="availableSkuRequest"> Filters for showing the available skus. </param>
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        public async ValueTask<Response<AvailableSkusResult>> ListAvailableSkusByResourceGroupNextPageAsync(string nextLink, string resourceGroupName, string location, AvailableSkuRequest availableSkuRequest, CancellationToken cancellationToken = default)
        {
            if (nextLink == null)
            {
