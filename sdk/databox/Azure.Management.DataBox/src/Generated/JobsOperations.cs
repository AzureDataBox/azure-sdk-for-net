...
namespace Azure.Management.DataBox
{
    ...
    public partial class JobsOperations
    {
        ...
        internal JobsOperations(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, string subscriptionId, Uri endpoint = null, string apiVersion = "2020-04-01")
        {
        ...
        {
            using var scope = _clientDiagnostics.CreateScope("JobsOperations.BookShipmentPickUp");
            scope.Start();
            try
            {
        ...
        public virtual AsyncPageable<JobResource> ListByResourceGroupAsync(string resourceGroupName, string skipToken = null, CancellationToken cancellationToken = default)
        {
            ...
            async Task<Page<JobResource>> FirstPageFunc(int? pageSizeHint)
            {
                using var scope = _clientDiagnostics.CreateScope("JobsOperations.ListByResourceGroup");
                scope.Start();
                try
                {
        ...
        public virtual AsyncPageable<UnencryptedCredentials> ListCredentialsAsync(string resourceGroupName, string jobName, CancellationToken cancellationToken = default)
        {
            ...
            {
                using var scope = _clientDiagnostics.CreateScope("JobsOperations.ListCredentials");
                scope.Start();
                try
                {
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        public virtual async Task<JobsCreateOperation> StartCreateAsync(string resourceGroupName, string jobName, JobResource jobResource, CancellationToken cancellationToken = default)
        {
            if (resourceGroupName == null)
            {
                throw new ArgumentNullException(nameof(resourceGroupName));
            ...
            using var scope = _clientDiagnostics.CreateScope("JobsOperations.StartCreate");
            scope.Start();
            try
            {
        ...
        /// <param name="jobName"> The name of the job Resource within the specified resource group. job names must be between 3 and 24 characters in length and use any alphanumeric and underscore only. </param>
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        public virtual async Task<JobsDeleteOperation> StartDeleteAsync(string resourceGroupName, string jobName, CancellationToken cancellationToken = default)
        {
            if (resourceGroupName == null)
            {
                throw new ArgumentNullException(nameof(resourceGroupName));
            ...
            using var scope = _clientDiagnostics.CreateScope("JobsOperations.StartDelete");
            scope.Start();
            try
            {
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        public virtual async Task<JobsUpdateOperation> StartUpdateAsync(string resourceGroupName, string jobName, JobResourceUpdateParameter jobResourceUpdateParameter, string ifMatch = null, CancellationToken cancellationToken = default)
        {
            if (resourceGroupName == null)
            {
                throw new ArgumentNullException(nameof(resourceGroupName));
            ...
            using var scope = _clientDiagnostics.CreateScope("JobsOperations.StartUpdate");
            scope.Start();
            try
            {
